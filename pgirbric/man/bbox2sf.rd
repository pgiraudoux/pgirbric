...
This function converts a set of coordinates limiting a bounding box into a POLYGON geometry (see \code{\link[sf]{st_sfc}}. It can be used for instance to clip a subset of a larger spatial object (e.g. using \code{\link[sf]{st_intersection}})
}
